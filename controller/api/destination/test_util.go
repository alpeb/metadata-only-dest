...
spec:
  ...
  proxyProtocol: opaque`,
	...
	metadataK8sAPI, err := k8s.NewFakeMetadataAPI(res...)
	if err != nil {
	...
	err = watcher.InitializeIndexers(k8sAPI, metadataK8sAPI)
	if err != nil {
	...
	servers, err := watcher.NewServerWatcher(metadataK8sAPI, log)
	if err != nil {
		t.Fatal(err)
	}
